...
appendRow.addEventListener("click", ()=>{
    ...
    if (currRows === maxLim) appendRow.disabled = true;
});
removeRow.addEventListener("click", ()=>{
    ...
    if (currRows === minLim) removeRow.disabled = true;
});
appendColumn.addEventListener("click", ()=>{
    ...
    if (currCols === maxLim) appendColumn.disabled = true;
});
removeColumn.addEventListener("click", ()=>{
    ...
    if (currCols === minLim) removeColumn.disabled = true;
});
